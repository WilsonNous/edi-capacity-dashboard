...
PADROES = {
    ...
    "CANCELAMENTO_TRAFEGO": [
        (r"\bcancel(?:ar|amento)\b.*\btr[aá]fego\b", 8),
        (r"\btr[aá]fego\b.*\bcancel(?:ar|amento)\b", 8),
        (r"\bprosseguir\b.*\bcancelamento\b.*\btr[aá]fego\b", 8),
        (r"\bcancelar\b", 3),
    ],
}
...
TIPO_OFICIAL = [
    ...
    (r"cancel(?:ar|amento).*tr[aá]fego|tr[aá]fego.*cancel", "CANCELAMENTO_TRAFEGO"),
]
...
SUBTIPOS = [
    ...
    ("CANCELAMENTO_TOTAL", [r"cancel(?:ar|amento).*tr[aá]fego", r"prosseguir.*cancelamento"]),
]
...
def _extrair_subtipo(texto: str, intencao: str) -> str:
    ...
    return {
        ...
        "CANCELAMENTO_TRAFEGO": "CANCELAMENTO_TOTAL",
